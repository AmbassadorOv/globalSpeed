...
export function Header(props: HeaderProps) {
  ...
  return (
    <div className="Header">
      ...
      {/* Options page */}
      <button aria-label={gvar.gsm.options.flags.header} title={gvar.gsm.options.flags.header} onClick={e => {
      ...
      {/* Github */}
      <button aria-label={gvar.gsm.token.github} title={gvar.gsm.token.github} onClick={e => {
