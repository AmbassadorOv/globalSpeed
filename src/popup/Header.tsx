...
export function Header(props: HeaderProps) {
  ...
  return (
    <div className="Header">
      ...
      {/* Options page */}
      <button aria-label="Open options page" title={gvar.gsm.token.openOptions} onClick={e => {
      ...
      {/* Github */}
      <button aria-label="Open GitHub page" title={gvar.gsm.token.openGithub} onClick={e => {
