...
export function Header(props: HeaderProps) {
  ...
  return (
    <div className="Header">
      ...
      {/* Status */}
      <button
        title={gvar.gsm.token.toggleTooltip}
      ...
      {/* Options page */}
      <button title={gvar.gsm.token.openOptionsTooltip} aria-label="Open options page" onClick={e => {
      ...
      {/* Github */}
      <button title={gvar.gsm.token.openGithubTooltip} aria-label="Open GitHub page" onClick={e => {
