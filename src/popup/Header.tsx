...
export function Header(props: HeaderProps) {
  ...
  return (
    <div className="Header">
      ...
      {/* Status */}
      <button
        title="Toggle extension (Right-click to disable globally)"
...
export function FxIcon(props: FxIconProps) {
  ...
  return (
    <button
      title="Toggle video filters (Right-click to reset)"
...
export function AudioIcon(props: AudioIconProps) {
  ...
  return (
    <button
      title="Toggle audio effects (Right-click to reset)"
...
export function CircleIcon(props: CircleIconProps) {
  ...
  return (
    <button
      title="Toggle circle widget (Right-click to disable)"
