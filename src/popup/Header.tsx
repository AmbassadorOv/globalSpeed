...
export function Header(props: HeaderProps) {
  ...
  return (
    <div className="Header">
      ...
      {props.panel !== 0 ? (
        <button
          aria-label={gvar.gsm.token.goBack}
          title={gvar.gsm.token.goBack}
      ...
      {/* Options page */}
      <button
        aria-label={gvar.gsm.token.openOptions}
        title={gvar.gsm.token.openOptions}
        onClick={e => {
      ...
      {/* Github */}
      <button
        aria-label={gvar.gsm.token.openGithub}
        title={gvar.gsm.token.openGithub}
        onClick={e => {
...
export function CircleIcon(props: CircleIconProps) {
  ...
  return (
    <button
      aria-label={gvar.gsm.token.toggleCircle}
      title={gvar.gsm.token.toggleCircle}
